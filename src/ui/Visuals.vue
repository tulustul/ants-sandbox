...
watch(state.visualSettings.shaders, () => {
  for (const graphic of simulation.garden.fieldsLayer.graphics) {
    graphic.filter.uniforms.exposure =
      state.visualSettings.shaders.pheromoneExposure;
    graphic.filter.uniforms.contrast =
      state.visualSettings.shaders.pheromoneContrast;
  }
});
...
<template>
  ...
  <Checkbox
    label="To food layer enabled"
    v-model="state.visualSettings.toFoodEnabled"
  />
  <Checkbox
    label="To food max layer enabled"
    v-model="state.visualSettings.toFoodMaxEnabled"
  />
  <Checkbox
    label="To home layer enabled"
    v-model="state.visualSettings.toHomeEnabled"
  />
  <Checkbox
    label="To home max layer enabled"
    v-model="state.visualSettings.toHomeMaxEnabled"
  />
  <Checkbox
    label="To enemy layer enabled"
    v-model="state.visualSettings.toEnemyEnabled"
  />
  <Checkbox
    label="To enemy max layer enabled"
    v-model="state.visualSettings.toEnemyMaxEnabled"
  />
